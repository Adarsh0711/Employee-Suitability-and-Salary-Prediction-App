...
# Loading models
with open('/Users/adarshreddy/Documents/vscode/decision_tree_model.pkl', 'rb') as file:
    decision_tree_model = pickle.load(file)
with open('/Users/adarshreddy/Documents/vscode/regression.pkl', 'rb') as file:
    regression_model = pickle.load(file)

employability_data = pd.read_csv('/Users/adarshreddy/Documents/vscode/model_data.csv')
salary_data = pd.read_csv('/Users/adarshreddy/Documents/vscode/processed_salary_data.csv')
full_data = pd.read_csv('/Users/adarshreddy/Documents/vscode/stackoverflow_full.csv')
